...
export const UniversalGamePlayer: React.FC<UniversalGamePlayerProps> = ({
  ...
  const { patient, navigate, currentRoute, recordActivityPlay, showToast, t } = useApp();
  ...
  const rawGameDef = gamesLibrary.find(g => g.id === activeGameId) || gamesLibrary[0];
  const gameDef = getLocalizedGame(rawGameDef, t);
