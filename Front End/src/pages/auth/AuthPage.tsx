        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs sm:text-sm text-slate-500 max-w-sm mx-auto">
            {mode === 'forgot-password'
              ...
              : mode === 'login'
              ? 'Sign in to access your daily cognitive activities and reminders.'
              : selectedRole === 'patient'
              ? 'Join Axiom for gentle daily brain games and memory assistance.'
              : 'Connect with your patient to monitor progress and care.'}
          </p>
        </div>
        ...
        {mode === 'login' && (
          <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-xl shadow-slate-200/50 space-y-5">
            ...
            <div className="grid grid-cols-2 bg-slate-100 p-1 rounded-2xl border border-slate-200">
              ...
              >
                <HeartHandshake size={15} /> Caregiver
              </button>
            </div>
        ...
        {mode === 'forgot-password' && (
          <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-xl shadow-slate-200/50 space-y-5">
            <form onSubmit={handleForgotPasswordSubmit} className="space-y-4">
              ...
              >
                <span>{isLoading ? 'Sending...' : 'Send Recovery Email'}</span>
                <ArrowRight size={16} />
              </button>
            </form>
