...
import { Shield, Lock, Mail, ArrowRight, UserCheck, HeartHandshake } from 'lucide-react';
...
export const CaregiverLoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-indigo-950 to-slate-900 flex flex-col justify-between p-4 sm:p-6 md:p-10 text-white">
      <div className="max-w-md mx-auto w-full my-auto space-y-6">
        ...
        <div className="bg-slate-800/90 backdrop-blur-md rounded-3xl p-6 sm:p-8 border border-slate-700 shadow-2xl space-y-5">
          <div className="inline-flex items-center gap-1.5 text-xs font-bold text-teal-400 bg-teal-950/60 px-3 py-1 rounded-full border border-teal-800/60">
            <UserCheck size={14} /> SIH Demo Mode Active
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="pt-2">
              <button
                type="submit"
                className="w-full py-3.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-2xl font-bold text-base transition-colors shadow-lg shadow-indigo-600/30 flex items-center justify-center gap-2 cursor-pointer"
              >
