...
-- ==============================================================================
-- Row Level Security (RLS) Policies (Enable read/write for Web App client)
-- ==============================================================================
...
-- Allow anonymous and authenticated access for demo & hackathon web portal
DO $$
BEGIN
    -- Patients
...
-- Enable Realtime on key live tables
